# Codex v2.8 — Room Render Definitions
...
Source integrated from: /chatGPT/codexVault/Codex_v2.4_Canon_Render_Rooms.md
Status: Local/GitHub working integration file created from v2.4 room-render canon and adapted to the v2.8 modular structure.

---

# Integration Rule

This file restores room-level visual canon and render blocks that existed in Codex v2.4 and were not present in the minimal v2.8 required release set.

This file supplements, but does not override, the active v2.8 files:

- /chatGPT/sessionRules/Codex_v2.8_Bootstrap.md
- /chatGPT/codexVault/Codex_v2.8_Canon_Core.md
- /chatGPT/roomVault/Codex_v2.8_Room_Index.md
- /chatGPT/mapVault/Codex_v2.8_Map_Core.md
- /chatGPT/renderVault/Codex_v2.8_Render_Core.md

Where this file conflicts with v2.8 topology, direct-adjacency, non-adjacency, Garden separation, map, prompt approval, or runtime binding rules, the active v2.8 rules control.

Where this file adds room visual identity, required features, station definitions, facing-direction guidance, compliance checks, or non-canonical mistake lists without conflicting with v2.8, those details are active room-render canon.
...
This file restores the room-render canon confirmed from Codex v2.4 source content visible through the GitHub connector in this session. Any additional v2.4 room definitions beyond the fetched visible content should be migrated in a follow-up expansion pass before final GitHub publication.

End of Codex v2.8 — Room Render Definitions.
