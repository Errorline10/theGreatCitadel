...
Supersedes: /chatGPT/sessionRules/Codex_v2.5_Bootstrap.md

---

# Required Release Manifest

A complete v2.6 Codex release contains these required files:

1. /chatGPT/sessionRules/Codex_v2.6_Bootstrap.md
2. /chatGPT/codexVault/Codex_v2.6_Canon_Core.md
3. /chatGPT/codexVault/Codex_v2.6_Room_Index.md
4. /chatGPT/mapVault/Codex_v2.6_Map_Core.md
5. /chatGPT/renderVault/Codex_v2.6_Render_Core.md

Optional future files:

- /chatGPT/codexVault/Codex_v2.6_Symbol_Index.md
- /chatGPT/stationVault/Codex_v2.6_Station_Index.md
- /chatGPT/referenceVault/Codex_v2.6_Reference_Index.md
...
The active v2.6 file set is the source of truth for The Great Citadel.
...
When a user request refers to “the Citadel,” “a room,” “a map,” “a render,” “the Codex,” or any named Citadel location, the active v2.6 file set must be treated as mandatory source context, not optional reference material.
...
Codex v2.6 strengthens runtime binding and render/map discipline.

Major changes:

- Requires all Citadel requests to bind to the active Codex file set.
- Requires Codex-grounded prompt compilation before tool use.
- Requires full image prompt display and user approval before generation.
- Prohibits generic fantasy atlas behavior for Citadel maps.
- Adds direct physical adjacency priority for Garden and Entry Hall.
- Strengthens pre-generation map compliance gates.

End of Codex v2.6 — Bootstrap.
