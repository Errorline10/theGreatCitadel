# Codex v2.8 — Bootstrap

Project: The Great Citadel
Version: v2.8
Role: First-load bootstrap, file manifest, initialization order, protocol activation, runtime Codex binding, prompt approval, file save rules, and release file structure.
Supersedes: /chatGPT/sessionRules/Codex_v2.7_Bootstrap.md

---

# Required Release Manifest

A complete v2.8 Codex release contains these required files:

1. /chatGPT/sessionRules/Codex_v2.8_Bootstrap.md
2. /chatGPT/codexVault/Codex_v2.8_Canon_Core.md
3. /chatGPT/roomVault/Codex_v2.8_Room_Index.md
4. /chatGPT/mapVault/Codex_v2.8_Map_Core.md
5. /chatGPT/renderVault/Codex_v2.8_Render_Core.md

Optional future files:

- /chatGPT/codexVault/Codex_v2.8_Symbol_Index.md
- /chatGPT/stationVault/Codex_v2.8_Station_Index.md
- /chatGPT/referenceVault/Codex_v2.8_Reference_Index.md

---

# Repository Structure Rule

Room Index files belong in /chatGPT/roomVault/.

Canon Core files belong in /chatGPT/codexVault/.

Map Core files belong in /chatGPT/mapVault/.

Render Core files belong in /chatGPT/renderVault/.

Bootstrap files belong in /chatGPT/sessionRules/.

The Room Index must not be stored in codexVault for v2.8 and later releases unless a future release explicitly changes the repository structure.
...
The active v2.8 file set is the source of truth for The Great Citadel.

Bootstrap governs setup, loading, versioning, save behavior, activation, runtime binding, compilation, approval gates, and release file structure.
...
When a user request refers to “the Citadel,” “a room,” “a map,” “a render,” “the Codex,” or any named Citadel location, the active v2.8 file set must be treated as mandatory source context, not optional reference material.
...
Codex v2.8 formalizes the Room Index repository structure.

Major changes:

- Moves Room Index from /chatGPT/codexVault/ to /chatGPT/roomVault/.
- Adds a Repository Structure Rule.
- Updates the required release manifest to use /chatGPT/roomVault/Codex_v2.8_Room_Index.md.
- Preserves v2.7 topology separation, runtime binding, prompt compilation, approval gate, and map discipline rules.

End of Codex v2.8 — Bootstrap.
