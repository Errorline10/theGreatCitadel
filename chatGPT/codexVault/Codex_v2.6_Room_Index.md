# Codex v2.6 — Room Index

Project: The Great Citadel
Version: v2.6
Role: Room definitions, room connections, stations, antechambers, and room-specific canon.
Supersedes: /chatGPT/codexVault/Codex_v2.5_Room_Index.md
...
Required features: side tables, coat hooks, cloaks or jackets, travel bags, warm lantern light, wood-softened stone architecture, plants or vines, worn stone floor, and a clear forward path.

North-facing visual specification: Viewer stands near the center facing north. North Door is centered or near-centered ahead and open by default. Small Library is visible beyond the North Door and must read as a compact study room. West Door is visible on the left wall. South Door is behind the viewer and not visible.

## Entry Hall Garden Attachment Rule

The West Door is built directly into the west wall of the Entry Hall.

Opening the West Door immediately enters the Garden.

The visitor does not pass through any intermediate space.

The Garden begins directly beyond the doorway.

---

# Garden

Purpose: The Garden is a meditation branch space physically attached directly to the west side of the Entry Hall.

Connection: Entry Hall West Door -> Garden East Door -> Garden.

Exactly one canonical door: east-wall door back to the Entry Hall.

The Garden East Door and the Entry Hall West Door are the same doorway connection.
...
Station: Garden — Buddha Statue Station.

## Garden Physical Attachment Rule

The Garden is physically attached directly to the west wall of the Entry Hall.

The Garden East Door and the Entry Hall West Door are the same doorway connection.

No corridor, hallway, vestibule, courtyard passage, tunnel, bridge, connector room, transition space, or intermediate structure exists between them.

When viewed on a map, the Garden boundary wall should touch or immediately adjoin the west side of the Entry Hall structure.

The canonical relationship is direct wall-to-wall adjacency.
...
The large prominent display book is the combined Instruction Manual and Guest Book. It sits in the northeast corner and must not block the north door.
...
North-facing visual specification: Viewer stands at or near the geometric center upon the Great Knowledge Compass and faces north. The North Science Door is centered or near-centered. Northwest History may appear left. Northeast Philosophy may appear right. South Foundational Door is behind the viewer and not visible.
...
Antechambers are transitional rooms between the Great Hall and deeper realm paths. They are not full realms.

Arts Antechamber: North Music Door, East Writing Door, South Visual Door, West Great Hall Door.

Media Antechamber: North Movie Theater Door, East Great Hall Door, South Physical Archive Index Door, West Audio Theater Door. No televisions, digital screens, neon, or modern media-center elements.

History Antechamber: archives, timelines, memory, records, ruins, preserved events.

Philosophy Antechamber: questions, contemplation, argument, ethics, metaphysics, meaning.

Personal Antechamber: memory, identity, reflection, inner life, personal history, self-understanding.

Inventor's Antechamber: invention, mechanisms, tools, experiments, prototypes, workshop thinking, Time Traveler modifications.

End of Codex v2.6 — Room Index.
